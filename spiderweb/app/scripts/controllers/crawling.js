...
spiderwebApp.controller('CrawlingCtrl', ['$scope', '$timeout', '$http', '$q', '$location', 'configService', 'resultsService', 'crawlService', 'folderService', function($scope, $timeout, $http, $q, $location, configService, resultsService, crawlService, folderService) {
  $scope.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',
    'Testacular'
