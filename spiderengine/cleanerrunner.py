#!/usr/bin/env python
"""TODO: push cleaning into MapReduce
    This file is totally cut and paste from spiderruner.py
...
def main():
    ...
    cleaner_runner = CleanerRunner(site_list, redis_info, 
                                 max_mappers, max_pages, options.crawlInfo) 
    cleaner_runner.execute()
