 ...
 *  
 */
spiderwebApp.controller('MainCtrl', ['$scope', '$http', '$timeout', '$location', 'sessionService', 'crawlService', 'configService', function($scope, $http, $timeout, $location, sessionService, crawlService, configService) {
  $scope.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',
    'Testacular'
