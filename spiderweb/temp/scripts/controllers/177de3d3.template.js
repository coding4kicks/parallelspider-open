...
spiderwebApp.controller('TemplateCtrl', ['$scope', '$dialog', '$cookieStore', '$http', 'sessionService', 'configService', function($scope, $dialog, $cookieStore, $http, sessionService, configService) {
  $scope.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',
    'Testacular'
